...
from tensorflow.keras.layers import Conv1D, Conv1DTranspose, MaxPooling1D, Dense, Activation, GroupNormalization
...
class Unet(tf.keras.Model):
    ...
    def Loss(self, y_pred, y_train):
        ...
        y_train = (y_train - self.Par['out_shift'])/self.Par['out_scale']
