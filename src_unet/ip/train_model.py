...
def main():
    ...
    d = io.loadmat("../../data/intermediate_pressure_ratio/training_dataset.mat")
    x_train, u_train, v_train = np.array(d['x']), np.array(d['utrain']), np.array(d['vtrain'])

    d = io.loadmat("../../data/intermediate_pressure_ratio/testing_dataset.mat")
    ...
    Par['tn_shift']  = tn_MIN
    Par['tn_scale']  = tn_MAX - tn_MIN

    print("inp_shift: ", Par['inp_shift'])
    print("inp_scale: ", Par['inp_scale'])
    print("out_shift: ", Par['out_shift'])
    print("out_scale: ", Par['out_scale'])
    print("tn_shift : ", Par['tn_shift'])
    print("tn_scale : ", Par['tn_scale'])
    ...
    for i in range(model_number+1, n_epochs+1):
        ...
        if i%1 == 0:
            ...
            val_loss = model.Loss(y_pred,y_test)[0]  
